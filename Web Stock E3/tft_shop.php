...
// ดึงข้อมูลสินค้า TFT เท่านั้น
$query = "SELECT * FROM Accounts WHERE status = 'available' AND game_id = '#TFT' ORDER BY account_id ASC";
...
<body>
    ...
    <!-- Header -->
    <div class="header">
        <h1>TEAMFIGHT TACTICS ACCOUNTS SHOP</h1>
        <p>เลือกซื้อไอดีเกม TFT คุณภาพดี การันตีทุกบัญชี</p>
    </div>
    ...
    <div class="modal" id="cart-modal">
        <div class="modal-content">
            ...
            <?php else: ?>
                <p style="text-align: center; padding: 20px 0;">ไม่มีสินค้าในตะกร้า</p>
            <?php endif; ?>
        </div>
    </div>
        ...
        <div class="products">
            ...
            <?php else: ?>
                <div style="grid-column: 1 / -1; text-align: center; padding: 40px;">
                    <h2>ไม่มีสินค้า TFT ในขณะนี้</h2>

...
// ดึงข้อมูลสินค้า LOL เท่านั้น
$query = "SELECT * FROM Accounts WHERE status = 'available' AND game_id = '#LOL' ORDER BY account_id ASC";
...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background: linear-gradient(135deg, #0A1428, #091428);
            color: white;
            line-height: 1.6;
        }
        ...
        .navbar {
            ...
            align-items: center;
            padding: 15px 20px;
            background: #1E2328; /* LOL dark */
            box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2);
            border-bottom: 2px solid #C89B3C; /* LOL gold */
        }
        ...
        .user-info {
            ...
            padding: 8px 12px;
            border-radius: 5px;
            border: 1px solid #785A28; /* LOL gold border */
        }
        ...
        .alert-error {
            background: rgba(168, 30, 30, 0.3);
            color: #ff6b6b;
            border: 1px solid #a82e2e;
        }

        .alert-success {
            background: rgba(30, 168, 50, 0.3);
            color: #8affb6;
            border: 1px solid #1ea832;
        }
...
<body>
    ...
    <!-- Header -->
    <div class="header">
        <h1>LEAGUE OF LEGENDS ACCOUNTS SHOP</h1>
        <p>เลือกซื้อไอดีเกม League of Legends คุณภาพดี การันตีทุกบัญชี</p>
    </div>
    ...
    <div class="modal" id="cart-modal">
        <div class="modal-content">
            ...
            <?php else: ?>
                <p style="text-align: center; padding: 20px 0; color: #F0E6D2;">ไม่มีสินค้าในตะกร้า</p>
            <?php endif; ?>
        </div>
    </div>
        ...
        <div class="products">
            ...
            <?php else: ?>
                <div style="grid-column: 1 / -1; text-align: center; padding: 40px;">
                    <h2 style="color: #C89B3C;">ไม่มีสินค้า League of Legends ในขณะนี้</h2>
                    <p style="color: #F0E6D2;">กรุณากลับมาใหม่ในภายหลัง</p>
                </div>
            <?php endif; ?>
        </div>
    </div>

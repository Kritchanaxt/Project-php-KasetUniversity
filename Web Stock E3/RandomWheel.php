...
function getRarityDescription($rarity) {
    switch ($rarity) {
        ...
        case 'uncommon':
            return 'แอคเคาท์ทั่วไป พอใช้ได้';
        case 'rare':
            return 'แอคเคาท์หายาก มีไอเทมพิเศษหลายอย่าง';
        case 'epic':
            return 'แอคเคาท์ระดับสุดยอด มีไอเทมมากมาย';
        case 'legendary':
            return 'แอคเคาท์ระดับตำนาน ครบทุกอย่าง!';
        default:
            return '';
    }
}
...
function getSpecialItems($rarity, $game) {
    ...
    switch ($rarity) {
        ...
        case 'legendary':
            ...
            $items[] = 'ของลิมิเต็ด หาไม่ได้อีกแล้ว';
            $items[] = 'เอาไปไม่ต้องเติมอีก';
            break;
    }
    ...
    if ($game == 'TFT') {
        if ($rarity == 'epic' || $rarity == 'legendary') {
            $items[] = 'Little Legends,Board ครบหมด';
        }
...
<head>
    ...
    <title>Game ID Randomizer | สุ่มไอดีเกม</title>
...
<body>
    ...
    <!-- Header -->
    <div class="header">
        <h1>RANDOM ID GAME</h1>
        <p>สุ่มเลยคุณมีโอกาสได้ไอดีระดับตำนาน!</p>
    </div>
